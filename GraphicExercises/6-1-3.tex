...
For each of the following stereo illustrations of a linear transformation of the unit cube, estimate the matrix of the linear transformation (to within say~20\%). 
Then use formula~(6.1) to estimate the determinant of the matrix of the transformation.
...
\ThreeD{-2.0}{0.9}{-1.2}{-1.3}{0.9}{0.0}{0.0}{1.0}{0.0}
