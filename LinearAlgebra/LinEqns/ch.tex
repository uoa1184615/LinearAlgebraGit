...
Such transformations and their practical implications are the subject of \text{this book.}
...
In computing science this task is often called `\idx{data mining}', `\idx{knowledge discovery}' or `\idx{artificial intelligence}'---although  the algebraic relation is then typically discussed as a computational procedure.
But always appearing within such tasks are linear equations to \text{be solved.}
...
Such progressive refinement is fundamental scientific methodology---and central to it is the algebra of \text{linear equations.}
\end{example}
