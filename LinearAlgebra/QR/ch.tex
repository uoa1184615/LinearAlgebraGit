...
\chapter{QR factorization underlies many algorithms}
\label{ch:qrfuma}
...
\item QR factorization \cite[\S8.3]{Nakos1998}, Gram--Schmidt, orthog poly, stabilised, ensemble forecasting (again?)
\item possibly Householder orthog diagonalization
