...
\item \autoref{ch:eesm} generalized symmetric eigen-problem \(A\xv=\lambda B\xv\) and orthog with weighted inner product, relate to FT, Hermitian matrices
...
\item \autoref{ch:gee} eigen-problem, linear independence, generalized eigenvectors, basis, change of basis
\end{itemize}
