...
\item generalised symmetric eigen-problem \(A\xv=\lambda B\xv\) and orthog with weighted inner product
...
\item eigen-problem, linear independence, generalised eigenvectors, basis, change of basis, relate to FT, Hermitian matrices
\end{itemize}
...
\item \autoref{ch:eesm} generalised symmetric eigen-problem \(A\xv=\lambda B\xv\) and orthog with weighted inner product, relate to FT, Hermitian matrices
...
\item \autoref{ch:gee} eigen-problem, linear independence, generalised eigenvectors, basis, change of basis
\end{itemize}
