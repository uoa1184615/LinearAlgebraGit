...
%
%\subsection{Fields generalize numbers}
%\label{sec:fgn}
%
...
Recall from the start of \cref{ch:v} that the term \idx{scalar} refers to a number that could be integer, real or complex, but usually was a real number.
...
%The previous \cref{sec:fgn} extended the idea of real and complex numbers to general fields.  
%For ease of discussion we define ``scalar'' to encompass generalized numbers.
