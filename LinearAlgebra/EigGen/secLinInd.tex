...
The answer is yes:  for a given \idx{linear transformation} (\autoref{sec:ilt}), the numbers in the components of its matrix also depend upon the coordinate basis. }
\end{example}
