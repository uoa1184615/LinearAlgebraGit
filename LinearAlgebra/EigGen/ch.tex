...
Row or column swaps could transform it to be triangular, but we have not investigated the effect of such swaps on eigenvalues \text{and eigenvectors.}
\end{solution}
\end{enumerate}
\end{example}
...
Correspondingly, the next \cref{sec:eennm} establishes there are precisely \(n\)~eigenvalues of general \(n\times n\) matrices, provided we count the eigenvalues according to multiplicity and allow \idx{complex eigenvalue}s.
