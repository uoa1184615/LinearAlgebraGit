...
A general solution is, in terms of two constants~\(c_1\) and~\(c_2\), that one \idx{species} has female population \(y(t)=2c_14^t+2c_2\) whereas the second species has female population \(z(t)=-c_14^t+c_2\)\,.
