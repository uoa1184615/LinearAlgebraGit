...
\begin{aside}
The \script[1]\ function \index{eigshow()@\texttt{eigshow()}}\texttt{eigshow(A)}\footnote{Download for R2017b etc.} provides an interactive alternative to this static view.
\end{aside}%
...
\( A=\begin{bmat} 0&1\\-1&1/2 \end{bmat}\), \marginpar{\eRose01{-1}{0.5}}%
