...
\end{tikzpicture}
\end{wrapfigure}
This equation determines the coefficients: \(2c_1+2c_2=22\)
and \(-c_1+c_2=9\)\,.
...
Let \(n\times n\) \idx{square matrix}~\(A\) be \idx{diagonalizable} by the invertible matrix \(P=\begin{bmatrix} \pv_1&\pv_2&\cdots&\pv_n \end{bmatrix}\) whose columns are \idx{eigenvector}s corresponding to \idx{eigenvalue}s \hlist\lambda n\ of matrix~\(A\).  
