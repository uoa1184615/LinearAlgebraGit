...
\end{equation*}
In \script, construct this matrix with \index{auto-replication}\verb|U=(lambda.^(0:n-1)).'|   (see \cref{tbl:mtlbnorm}).
\end{enumerate}
\fi%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item Any two bases for a given \idx{subspace} have the same number of vectors (\cref{thm:sameDii}).
