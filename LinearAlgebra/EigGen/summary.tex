...
\itemhi Let \(n\times n\) \idx{square matrix}~\(A\) be \idx{diagonalizable} by the invertible matrix \(P=\begin{bmatrix} \pv_1&\pv_2&\cdots&\pv_n \end{bmatrix}\) whose columns are \idx{eigenvector}s corresponding to \idx{eigenvalue}s \hlist\lambda n.  
