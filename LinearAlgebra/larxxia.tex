...
\or%3= version on A4
   ...
   \excludeversion{reduce}% invoke this for a shortened version
%   \def\qrcode{}% invoke to omit QR-codes, although still ghost
%   \def\titlePageInfo{...}
...
\usepackage{linearAlgebra}[2017/10/31]
% an environment to control/show a reduced/shortened version
\newenvironment{reduce}{\color{gray}}{}
