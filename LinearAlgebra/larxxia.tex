...
\or%3= version on A4
   ...
   \def\ajr#1{}% redundant??
%   \def\titlePageInfo{Please inform me of typographical glitches, 
%   writing infelicities, and errors.}
   }%end of AtBeginDocument
\fi

% specify the version number of the next version
\AtBeginDocument{\SetWatermarkText{\quad v0.3a}}
...
\usepackage{linearAlgebra}[2016/08/07]
...
% this catches any answers not yet typeset, to check all OK
\begin{draft}
\makeanswers
\end{draft}
