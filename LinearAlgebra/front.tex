...
This new route through linear algebra becomes a preferred approach both because of the ready availability of ubiquitous computing and because of the importance of data science in the \text{21st century.}


\begin{quoted}{\cite{Turner2014}}%[p.30]
...
What such useful terms mean, their relationships, and their use in applications are central to the mathematical development in this book: you will see them introduced early \text{and used often.}
...
Interspersed throughout the text are questions labelled ``Activity'': these help form and test your developing understanding of \text{the concepts.}
...
\begin{quoted}{\cite{Arnold2014}}%[p.xiii]
...
In addition to many exercises at the end of each section, throughout the book are questions labelled ``Activity''.
...
\begin{quoted}{\cite{CUPMguide2015}}%[p.38]
