...
Question: Why should students have to wait until the end of the course to be introduced to beauty and power of this jewel?
...
Thereafter we use its beautiful power to both explore many modern applications and also to develop traditional linear algebra concepts, theory, and methods.
...
\item include quick questions for `active learning';
\item section/chapter summaries, and possibly concept maps;
...
The central computational tools to understand are the operation~`\verb|A\|' for solving straightforward linear equations; the \svd\ for difficult linear equation; the \svd\ for approximation; and \verb|eig| for probing structures.
...
So too is computing power: students can execute \script\ not only on laptops, but also on tablets and smart phones, perhaps using university or public servers, \script[1]-Online or \script[1]-Mobile. 
