...
\item For every \(n\times n\) \idx{square matrix}~\(A\), the \idx{magnitude} of its determinant \(|\det A|=\sigma_1\sigma_2\cdots\sigma_n\)\,, the product of all its \idx{singular value}s (\autoref{thm:detsvd}).
...
the \idx{determinant} of~\(A\) is the product of the \idx{diagonal entries}, \(\det A=a_{11}a_{22}\cdots a_{nn}\) (\autoref{thm:rpdet:vi}).
