...
For each of the given illustrations of a \idx{linear transformation} of the \idx{unit square}, `guesstimate' by eye the \idx{determinant} of the matrix of the transformation (estimate to an error of say~33\% or so).
\begin{Parts}
