...
Recognise that the ordered pairs of numbers in the position vectors are exactly the \idx{coordinates} of each of the specified end-points. 
\end{example}
...
\begin{activity}
Given \idx{word vector}s \(\wv=(N_{\text{cat}}\clb N_{\text{dog}}\clb N_{\text{mat}}\clb N_{\text{sat}}\clb N_{\text{scratched}})\) as in \autoref{eg:deflsv},
