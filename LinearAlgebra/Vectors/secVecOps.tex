...
That the order of addition is immaterial is the \idx{commutative law} of vector addition that is established in general by \cref{thm:vecopsa}.
...
\item Comment on why many of the properties (\cref{thm:vecops}) of vector operations appear the same as those for operations with real numbers. 
